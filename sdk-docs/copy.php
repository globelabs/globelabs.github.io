...
$copy = [
    ...
    'Subscriber' => [
        'Overview' => 'Subscriber Data Query API interface allows a Web application to query the customer profile of an end user who is the customer of a mobile network operator.',
        'Calls' => [
        ...
        'SMS' => [
            ...
            'Calls' => [
                ...
                'Mobile Originating (SMS-MO)' => [
                    ...
                    'Code' => $samples['php']['SMS Receiving'],
    ...
    'Ruby' => [
        ...
        'SMS' => [
            ...
            'Calls' => [
                ...
                'Mobile Originating (SMS-MO)' => [
                    'Overview' => $copy['SMS']['Calls']['Receiving'],
                    'Code' => $samples['ruby']['SMS Receiving'],
                    'Results' => $output['SMS Receiving']
                ]
            ]
        ],
    ...
    'NodeJS' => [
        ...
        'SMS' => [
            ...
            'Calls' => [
                ...
                'Mobile Originating (SMS-MO)' => [
                    'Overview' => $copy['SMS']['Calls']['Receiving'],
                    'Code' => $samples['nodejs']['SMS Receiving'],
                    'Results' => $output['SMS Receiving']
                ]
            ]
        ],
